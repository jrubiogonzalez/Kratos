...
///@{
    ...
    // Debugging variables
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, int, DEBUGGING_LEVEL);               // The debugging level considered
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, int, INTEGRATION_GAUSS_POINT_INDEX); // The integration point index
    KRATOS_DEFINE_APPLICATION_VARIABLE( STRUCTURAL_MECHANICS_APPLICATION, int, OWNER_ELEMENT_ID);              // The element owner id
